...
func (x *GservicesSetting) Reset() {
	*x = GservicesSetting{}
	mi := &file_gm_checkin_proto_msgTypes[0]
...
func (*GservicesSetting) Descriptor() ([]byte, []int) {
	return file_gm_checkin_proto_rawDescGZIP(), []int{0}
}
...
func (x *AndroidCheckinRequest) Reset() {
	*x = AndroidCheckinRequest{}
	mi := &file_gm_checkin_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AndroidCheckinRequest) Descriptor() ([]byte, []int) {
	return file_gm_checkin_proto_rawDescGZIP(), []int{1}
}
...
func (x *AndroidCheckinResponse) Reset() {
	*x = AndroidCheckinResponse{}
	mi := &file_gm_checkin_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AndroidCheckinResponse) Descriptor() ([]byte, []int) {
	return file_gm_checkin_proto_rawDescGZIP(), []int{2}
}
...
var File_gm_checkin_proto protoreflect.FileDescriptor

const file_gm_checkin_proto_rawDesc = "" +
	"\n" +
	"\x10gm_checkin.proto\x12\x10gm_checkin_proto\x1a\x18gm_android_checkin.proto\"<\n" +
	"\x10GservicesSetting\x12\x12\n" +
	"\x04name\x18\x01 \x02(\fR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x02(\fR\x05value\"\xa8\x05\n" +
	...
	"\acheckin\x18\x04 \x02(\v2%.gm_checkin_proto.AndroidCheckinProtoR\acheckin\x12#\n" +
	...
	"\x12user_serial_number\x18\x16 \x01(\x05R\x10userSerialNumber\"\xf8\x02\n" +
	...
	" \x03(\tR\rdeleteSetting\x12<\n" +
	"\asetting\x18\x05 \x03(\v2\".gm_checkin_proto.GservicesSettingR\asetting\x12\x1b\n" +
	...
	"\fversion_info\x18\v \x01(\tR\vversionInfoB<H\x03Z8github.com/palchrb/garmin-email-forwarder/internal/hermes/internal/checkinpb"

var (
	file_gm_checkin_proto_rawDescOnce sync.Once
	file_gm_checkin_proto_rawDescData []byte
)

func file_gm_checkin_proto_rawDescGZIP() []byte {
	file_gm_checkin_proto_rawDescOnce.Do(func() {
		file_gm_checkin_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gm_checkin_proto_rawDesc), len(file_gm_checkin_proto_rawDesc)))
	})
	return file_gm_checkin_proto_rawDescData
}

var file_gm_checkin_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_gm_checkin_proto_goTypes = []any{
	(*GservicesSetting)(nil),       // 0: gm_checkin_proto.GservicesSetting
	(*AndroidCheckinRequest)(nil),  // 1: gm_checkin_proto.AndroidCheckinRequest
	(*AndroidCheckinResponse)(nil), // 2: gm_checkin_proto.AndroidCheckinResponse
	(*AndroidCheckinProto)(nil),    // 3: gm_checkin_proto.AndroidCheckinProto
}
var file_gm_checkin_proto_depIdxs = []int32{
	3, // 0: gm_checkin_proto.AndroidCheckinRequest.checkin:type_name -> gm_checkin_proto.AndroidCheckinProto
	0, // 1: gm_checkin_proto.AndroidCheckinResponse.setting:type_name -> gm_checkin_proto.GservicesSetting
...
func init() { file_gm_checkin_proto_init() }
func file_gm_checkin_proto_init() {
	if File_gm_checkin_proto != nil {
		return
	}
	file_gm_android_checkin_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gm_checkin_proto_rawDesc), len(file_gm_checkin_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gm_checkin_proto_goTypes,
		DependencyIndexes: file_gm_checkin_proto_depIdxs,
		MessageInfos:      file_gm_checkin_proto_msgTypes,
	}.Build()
	File_gm_checkin_proto = out.File
	file_gm_checkin_proto_goTypes = nil
	file_gm_checkin_proto_depIdxs = nil
}
