...
// Config is the top-level configuration for garmin-email-forwarder.
type Config struct {
...
func WriteExample(path string) error {
	example := `# garmin-email-forwarder configuration
# Run "garmin-email-forwarder login" to authenticate after editing this file.
